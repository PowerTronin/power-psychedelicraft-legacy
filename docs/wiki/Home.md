...
Скриншоты ниже сделаны в текущей сборке форка и помогают быстрее понять, как выглядят основные цепочки.

| Лаборатория | Растения |
| --- | --- |
| ![Лаборатория с трубами, колбами и подносами](images/lab-overview.png) | ![Грядка с растениями мода](images/plants-field.png) |

| Сушка | Станции | Насос |
| --- | --- | --- |
| ![Столы для сушки с ингредиентами](images/drying-tables.png) | ![Основные станции мода](images/stations-overview.png) | ![Насос, трубы и колба](images/pump-setup.png) |
